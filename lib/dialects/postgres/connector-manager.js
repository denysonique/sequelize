...
module.exports = (function() {
  var ConnectorManager = function(sequelize, config) {
    ...
    this.pgConfig       = Utils._.pick(this.config, 'user', 'database', 'password', 'port', 'host', 'ssl')
  ...
  ConnectorManager.prototype.connect = function(callback) {
    ...
    if (this.pooling) {
      ...
      this.pg.connect(this.pgConfig, connectCallback)
    } else {
      if (!!this.client) {
        ...
        this.client = new this.pg.Client(this.pgConfig)
